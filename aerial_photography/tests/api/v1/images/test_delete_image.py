...
def test_delete_image(
    ...
    '''
    Функция тестирования API удаления снимка
    '''
    ...
    response = client.delete(
        f"{settings.API_V1_STR}/image/delete_image", params={'id': requested_id},
    )
...
def test_delete_image_error_not_found(
        client: TestClient, db: Session
) -> None:
    '''
    Функция тестирования API удаления отсутствующего снимка
    '''

    response = client.delete(
        f"{settings.API_V1_STR}/image/delete_image", params={'id': 0},
    )
